...
import SharkTankIcon from "../../../assets/icons/sharktank-nav-header.svg";
    ...
    return (
        <div className="dapp-sidebar">
            <div className="branding-header">
                <Link href="https://sharktank.money" target="_blank">
                    <img alt="" src={SharkTankIcon} />
                </Link>
            ...
            <div className="dapp-menu-doc-link">
                <Link href="https://sharktank.gitbook.io/sharktank/" target="_blank">
